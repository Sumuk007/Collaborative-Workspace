      ...
      <div className="w-full max-w-lg relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="bg-white border-2 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-8 md:p-10">
          ...
          <div className="mb-8 border-b-2 border-black pb-6">
            ...
            <p className="font-mono text-xs text-gray-500 uppercase tracking-widest">Create your secure access profile.</p>
          </div>
          ...
          {error && (
            <div className="bg-red-50 border-2 border-red-600 p-4 mb-8 flex items-start gap-3">
              ...
              <span className="text-red-700 text-xs font-bold font-mono uppercase">{error}</span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start pt-2">
              <input
                ...
                type="checkbox"
                required
                className="w-5 h-5 border-2 border-black rounded-none text-black focus:ring-0 focus:ring-offset-0 bg-gray-50 cursor-pointer mt-0.5"
              />
              <label htmlFor="terms" className="ml-3 text-xs font-medium text-gray-600 cursor-pointer leading-5">
                I accept the <a href="#" className="text-black font-bold border-b-2 border-black hover:bg-black hover:text-white transition-colors">Terms of Service</a> and <a href="#" className="text-black font-bold border-b-2 border-black hover:bg-black hover:text-white transition-colors">Privacy Policy</a>
              </label>
            </div>
        ...
        <div className="absolute -top-4 -right-4 bg-black text-white px-3 py-1 font-mono text-xs font-bold transform rotate-3 shadow-lg z-20">
          REGISTER_NEW
        </div>
      </div>
    </div>
